class Monster extends Phaser.Scene {
    ...
    create() {
        ...
        my.sprite.leg1 = this.add.sprite(this.bodyX - 20, this.bodyY + 130, "monsterParts", "leg_blueC.png");
        my.sprite.leg2 = this.add.sprite(this.bodyX + 60 , this.bodyY + 130 , "monsterParts", "leg_blueC.png");
        my.sprite.arm1 = this.add.sprite(this.bodyX+110, this.bodyY+70, "monsterParts", "arm_blueD.png");
        my.sprite.arm2 = this.add.sprite(this.bodyX-110, this.bodyY+70, "monsterParts", "arm_blueD.png");
